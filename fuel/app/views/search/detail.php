                                ...
                                <tr>
                                    ...
                                    <td class="status">
                                        ...
                                        foreach ($employment_mark as $k => $v) {
                                            ...
                                            $employment_marks .= Constants::$employment_mark[$v] . '||';
                                        }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            ...
                                            <?php echo implode('、', $stations[$job->job_id]) ?>
                                            】
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="msg">
                        ...
                        <?php if ($job->url_youtube) { ?>
                            <div id="video">
                                ...
                                <iframe width="100%" height="320" src="<?php echo $job->url_youtube; ?>" frameborder="0"
                        ...
                        <div class="toggle">
                            <table class="tb_styform">
                                ...
                                <tr>
                                    <th>最寄り駅</th>
                                    <td>
                                        <?php foreach ($stations[$job->job_id] as $key => $station) { ?>
