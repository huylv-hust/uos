	...
	<div id="footer_link" class="pc">
		<div class="box">
			<ul>
				...
				<li><a href="<?php echo \Fuel\Core\Uri::base(); ?>privacy">個人情報保護方針</a>｜</li>
...
<script id="tagjs" type="text/javascript">
  (function () {
    ...
    tagjs.async = true;
    tagjs.src = "//s.yjtag.jp/tag.js#site=oaTrNdp";
    s.parentNode.insertBefore(tagjs, s);
  }());
</script>
<noscript>
  <iframe src="//b.yjtag.jp/iframe?c=oaTrNdp" width="1" height="1" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
</noscript>
