	...
	<div id="page_form" class="sty_form">
		<div class="section box_full">
			...
			<div class="f_contact box_full container">
				<div class="box">
					<button type="button" class="submit-btn" id="contact_l_btn"><img class="imghover" src="<?php echo \Uri::base(); ?>assets/common_img/btn_contact06.png" alt="入力内容を修正する" style="opacity: 1;"></button>
					<button type="button" class="submit-btn register-submit" id="contact_r_btn"><img class="imghover" src="<?php echo \Uri::base(); ?>assets/common_img/btn_contact05.png" alt="登録する" style="opacity: 1;"></button>
					<p>
...
$(document).ready(function(){
	$('button#contact_r_btn').click(function(){
        $('.submit-btn').attr('disabled', true);
		$('#confirm-form').submit();
	});
	$('button#contact_l_btn').click(function(){
        $('.submit-btn').attr('disabled', true);
