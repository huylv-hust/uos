	<div class="col2 urgent">
		<h2><img src="<?php echo \Fuel\Core\Uri::base(); ?>assets/images/index/ico_recruit01.png" alt="急募のお仕事">急募のお仕事</h2>
		<?php
			foreach($jobs as $job)
			{
		?>
				<div class="line">
					<a href="<?php echo \Fuel\Core\Uri::base(); ?>search/detail/<?php echo isset($job) ? $job->job_id : 0; ?>" class="job pic_l imghover clearfix">
						...
						<span class="msg">
							...
							<span class="yen" style="min-height: 30px;"><?php echo isset($job->salary_des) ? Utility::crop_string($job->salary_des,Constants::$limit_salary_des) : ''; ?></span>
						</span>
					</a><!-- /.job -->
				</div>
				<!-- /.line -->
