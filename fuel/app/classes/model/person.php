...
class Model_Person extends \Orm\Model
{
	...
	{
		$data = array();
		$select = DB::select('job.*','m_ss.ss_name','m_partner.branch_name','job.job_id','sssale.sale_name','m_group.name', 'm_partner.department_id')->from('job');
