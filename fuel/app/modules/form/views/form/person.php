						...
						<div class="sty_line tb_styform_warp">
							...
							<table class="tb_styform form_gray">
								...
								<tr>
									...
									<td>
										<?php echo Form::input('tel_1', Input::post('tel_1', isset($post) ? $post->tel_1 : ($person_info['tel'] ? explode('-', $person_info['tel'])[0] : '')), array('placeholder' => "0000", 'maxlength' => 5, 'size' => 4, 'onchange' => 'utility.zen2han(this)')); ?>
										-
...
<?php echo Form::textarea('notes', Input::post('notes', isset($post) ? $post->notes : $person_info['notes']), array('rows' => 5, 'cols' => 50, 'class' => 'txt_full')); ?>
						...
						<div class="service_box">
							...
							<div class="section">
								...
								<div class="container">
									...
									<p>
										『<a href="/privacy/">個人情報保護方針</a>』をご覧ください。
									</p>
								</div><!-- /.container -->
			...
			<div class="f_contact box_full container">
				<div class="box">
					<button type="button" class="submit-btn"><img class="imghover" src="<?php echo Uri::base() ?>assets/common_img/btn_contact.png" alt="利用規約に同意して確認画面へ"></button>
				</div><!-- /.f_contact -->
			</div><!-- /.box_full -->
