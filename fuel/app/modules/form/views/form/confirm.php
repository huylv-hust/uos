		...
		<div id="page_form" class="sty_form">
			<div class="section box_full">
				...
				<div class="f_contact box_full container">
					<div class="box">
						<a href="javascript:void(0)" onclick="submitform()" id="contact_l_btn"><img class="imghover" src="<?php echo \Uri::base(); ?>assets/common_img/btn_contact06.png" alt="入力内容を修正する" style="opacity: 1;"></a>
						<a  href="javascript:void(0)" id="contact_r_btn"><img class="imghover submit" src="<?php echo \Uri::base(); ?>assets/common_img/btn_contact04.png" alt="応募する" style="opacity: 1;"></a>
						<p>
